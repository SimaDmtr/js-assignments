[![Build Status](https://travis-ci.org/SimaDmtr/js-assignments.svg?branch=master)](https://travis-ci.org/SimaDmtr/js-assignments)
![Hackage-Deps](https://img.shields.io/hackage-deps/v/lens.svg)
[![Greenkeeper badge](https://badges.greenkeeper.io/SimaDmtr/js-assignments.svg)](https://greenkeeper.io/)
[![GitHub release](https://img.shields.io/github/release/SimaDmtr/js-assignments.svg)](https://github.com/SimaDmtr/js-assignments/releases/latest)
...
* Edit local README.md file and update all links (just replace all occurrences of `'SimaDmtr'` with your account name).
...
```
* Open https://github.com/SimaDmtr/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/SimaDmtr/js-assignments/builds).
